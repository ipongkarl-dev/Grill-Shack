...
import { TransactionLog, OrderSummary } from "../components/MarketModeWidgets";
    ...
    <div className="space-y-4" data-testid="market-mode">
      ...
      {transactions.length > 0 && (
        <Card className="bg-zinc-900 border-zinc-800">
          ...
          <CardContent>
            <TransactionLog transactions={transactions} onView={(txn) => { setViewingTxn(txn); setViewTxnOpen(true); }} />
          </CardContent>
        </Card>
      )}
